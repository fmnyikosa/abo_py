...
def initialize_bayes_opt_model_with_der( x_input, y_loss, y_grads, 
    ...
    print ' '
    print ' shapes of x_input, x_1 and x_2 '
    print(x_input.shape)
    print(x_1.shape)
    print(x_1.shape)
    
    print ' '
    print ' shapes of y_1 and y_2 '
...
gp_model   = initialize_bayes_opt_model( x,        y, 0.2, 1.5   )
# sample3    = get_bayes_opt_proposal_lcb( gp_model, 2, [0], [1]   )
# m_, v_     = gp_model.predict_y(sample3)
# updated    = update_bayes_opt_model(     gp_model, sample, m_    )
